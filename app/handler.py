...
@router.get('/get/{client_id}', response_model=list[Image], responses={200: {'content': {'application/json'}}},
            tags=['images'])
...
@router.get('/get/{uuid}', response_model=Image, responses={200: {'content': {'application/json'}}}, tags=['images'])
